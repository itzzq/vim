...
if g:atCompany
    ...
    " set tags+=D:/Ruchee/workspace/Apps/php/la_primer/vendor/laravel/framework/src/Illuminate/tags
    " set tags+=D:/Ruchee/workspace/Apps/php/zf_primer/vendor/zendframework/zendframework/library/Zend/tags
    " set tags+=D:/Ruchee/CLisp/src/tags
    " set path+=D:/Ruchee/MinGW/include
    " set path+=D:/Ruchee/MinGW/include/c++/4.8.1
    " set path+=D:/Ruchee/MinGW/include/boost
else
    " set tags+=D:/Develop/workspace/php/la_primer/vendor/laravel/framework/src/Illuminate/tags
    " set tags+=D:/Develop/workspace/php/zf_primer/vendor/zendframework/zendframework/library/Zend/tags
    set tags+=~/workspace/tsar/tags
    set path+=~/workspace/tsar/include
    " set path+=D:/Develop/MinGW/include
    " set path+=D:/Develop/MinGW/include/c++/4.8.1
    " set path+=D:/Develop/MinGW/include/boost
endif
...
" 对部分语言设置单独的缩进
au FileType sh,lisp set shiftwidth=2
au FileType sh,lisp set tabstop=2
...
let g:syntastic_mode_map={'mode': 'active',
            \'active_filetypes':  [],
            \'passive_filetypes': ['html', 'xhtml', 'smarty', 'blade']
            \}                               " 指定不需要检查的语言
